...
class TestFeaturesExtraction(unittest.TestCase):
    def test_having_ip_address(self):
        ...
        url_2 = "https://zlaagahu.keaa5l9fc0r.su/SV/MCRS/?ow=YRFPVLDOHGQJEBCKNWMIZXcleUVEpxzuPdfgROZSCGJjDwvQmHbtNrLYkTFXIiyqosBnAaKWhMQiFjSekcUaKYIrWNEOxLDJhbqwzdZAlfuvygpRGHTCsno&load=rtzwYyhMGDiLaCnJgXO&cs=QjVXzOPBqFNCgue"
    ...
    def test_url_length(self):
        ...
        url_3 = "https://zlaagahu.keaa5l9fc0r.su/SV/MCRS/?ow=YRFPVLDOHGQJEBCKNWMIZXcleUVEpxzuPdfgROZSCGJjDwvQmHbtNrLYkTFXIiyqosBnAaKWhMQiFjSekcUaKYIrWNEOxLDJhbqwzdZAlfuvygpRGHTCsno&load=rtzwYyhMGDiLaCnJgXO&cs=QjVXzOPBqFNCgue"

        self.assertEqual(url_length(url_1), 1, "The URL length is not suspicious.")
        self.assertEqual(url_length(url_2), -1, "The URL length is not suspicious.")
        self.assertEqual(url_length(url_3), -1, "The URL length is suspicious.")

    def test_having_at_symbol(self):
        url_1 = "https://relacionamentobigcentralsecurity.in-the-band.net/central-relacionamento/"
        url_2 = "https://zlaagahu.keaa5l9fc0r.su/SV/MCRS/?ow=YRFPVLDOHGQJEBCKNWMIZXcleUVEpxzuPdfgROZSCGJjDwvQmHbtNrLYkTFXIiyqosBnAaKWhMQiFjSekcUaKYIrWNEOxLDJhbqwzdZAlfuvygpRGHTCsno&load=rtzwYyhMGDiLaCnJgXO&cs=QjVXzOPBqFNCgue"
    ...
    def test_domain_registration_length(self):
        url_1 = "https://zlaagahu.keaa5l9fc0r.su/SV/MCRS/?ow=YRFPVLDOHGQJEBCKNWMIZXcleUVEpxzuPdfgROZSCGJjDwvQmHbtNrLYkTFXIiyqosBnAaKWhMQiFjSekcUaKYIrWNEOxLDJhbqwzdZAlfuvygpRGHTCsno&load=rtzwYyhMGDiLaCnJgXO&cs=QjVXzOPBqFNCgue"
